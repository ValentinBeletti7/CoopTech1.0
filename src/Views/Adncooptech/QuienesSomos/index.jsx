...
const QuienesSomos = () => {
  return (
    <>
      <Panel imagen="src/assets/sea-164989_1280.jpg"  seccion="ADN COOPTECH" subSeccion="Quienes somos"/>
     <div className={styles.contenido}>
      <Olas titulo='Modelo de Negocios'     color=" text-black	" posicion="1" imagen="src/assets/furniture-1840463_1280.jpg"        texto ="Nuestro compromiso va más allá de la tecnología: buscamos generar bienestar en las personas, mediante servicios de calidad y accesibles, a través de la tecnología y la innovación. "/>
